...
i=0
for metronome in range(0, len(metronomes)//2, 1):
    if i % 4 == 0:
        print(f'note{int(metronome + 1)} = new Square({distance / (metronomes[metronome][1]*30)}, {distance / (metronomes[-1 * (metronome+1)][1]*30)}, {320 - ((distance / metronomes[metronome][1]) * metronomes[metronome][0])}, {320 - ((distance / metronomes[-1 * (metronome+1)][1]) * metronomes[-1 * (metronome+1)][0])})')
    elif i % 4 == 1:
        print(f'note{int(metronome + 1)} = new Square({-1 * (distance / (metronomes[metronome][1]*30))}, {distance / (metronomes[-1 * (metronome+1)][1]*30)}, {370 - (320 - ((distance / metronomes[metronome][1]) * metronomes[metronome][0]))}, {320 - ((distance / metronomes[-1 * (metronome+1)][1]) * metronomes[-1 * (metronome+1)][0])})')
    elif i % 4 == 2:
        print(f'note{int(metronome + 1)} = new Square({distance / (metronomes[metronome][1]*30)}, {-1 * (distance / (metronomes[-1 * (metronome+1)][1]*30))}, {320 - ((distance / metronomes[metronome][1]) * metronomes[metronome][0])}, {370 - (320 - ((distance / metronomes[-1 * (metronome+1)][1]) * metronomes[-1 * (metronome+1)][0]))})')
    else:
        print(f'note{int(metronome + 1)} = new Square({-1 * (distance / (metronomes[metronome][1]*30))}, {-1 * (distance / (metronomes[-1 * (metronome+1)][1]*30))}, {370 - (320 - ((distance / metronomes[metronome][1]) * metronomes[metronome][0]))}, {370 - (320 - ((distance / metronomes[-1 * (metronome+1)][1]) * metronomes[-1 * (metronome+1)][0]))})')
    i+=1

if not len(metronomes) % 2 == 0: 
    print(f'note{len(metronomes)//2 + 1} = new Square({distance / (metronomes[len(metronomes)//2 + 1][1]*30)}, {distance / (metronomes[metronome][1]*30)}, {320 - ((distance / metronomes[metronome][1]) * metronomes[metronome][0])}, {320 - ((distance / metronomes[metronome][1]) * metronomes[metronome][0])})')
...
for i in range(0, len(metronomes), 2):
    print(f'note{int(i/2 + 1)}.create()')